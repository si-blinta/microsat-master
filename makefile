...
host: src/host.c src/microsat.c src/hostTools.c src/log.c src/portfolio.c
	@$(HOST-CC) $(HOST-CFLAGS) src/host.c src/microsat.c src/hostTools.c src/log.c src/portfolio.c -o bin/host $(HOST-LIBS)
	@echo "Compiled HOST"
